import { AppBar, Badge, Box, Button, Drawer, IconButton, List, ListItem, ListItemText, styled, Toolbar, Typography } from '@mui/material';
        ...
        <Box sx={{
          ...
          <Box sx={{
            ...
            <Box sx={{ display: { xs: "none", md: "flex" }, margin: "0 15px", alignItems: "center" }}>
              <PermIdentityIcon fontSize='small' sx={{ cursor: "pointer" }} />
            ...
            <SearchIcon fontSize='small' sx={{ cursor: "pointer", m: { xs: "0 5px", md: "0 15px" } }} />
            <NavLink to="/shopping-cart" style={{ display: "flex", alignItems: "center", justifyContent: "center", color: "#23A6F0" }}>
              <Badge badgeContent={cart.length} color='success' sx={{ mr: "10px" }}>
                <ShoppingCartIcon fontSize='small' sx={{ cursor: "pointer", m: "0px 5px 0px 15px" }} />
              </Badge>
            </NavLink>
            <NavLink to="/wishlist" style={{ display: "flex", alignItems: "center", justifyContent: "center", color: "#23A6F0" }}>
              <Badge badgeContent={wishlist.length} color='success' sx={{ mr: "10px" }}>
                <FavoriteBorderIcon fontSize='small' sx={{ cursor: "pointer", m: "0px 5px 0px 15px" }} />
              </Badge>
            </NavLink>
          </Box>
        </Box>

...
const TeamDetails: React.FC = () => {
    return (
        <Box>
            <Box maxWidth={"1050px"} mx="auto" sx={{ p: { xs: "75px 0 0 0", sm: "112px 0" } }}>
                <Stack sx={{ gap: { xs: "45px", sm: "112px" } }} gap="112px">
                    <Stack textAlign={"center"} gap="10px" alignItems={"center"}>
                        <Typography variant='h2' sx={{ fontSize: "40px" }} color="secondary">Meet Our Team</Typography>
                    ...
                    <Box>
                        <Box sx={{
                            ...
                            rowGap: "24px",
                            columnGap: "30px",
                            padding: { xs: "0 30px 48px 30px", sm: "0px 30px", md: "0px 30px", lg: "0px 0px" },
                            textAlign: "center"
                        }}>
                            {
                                teamDetail.map((item) => (
                                    <Box key={item.username} sx={{ width: "100%", margin: "0 auto", backgroundColor: "#FFFFFF" }}>
                                        <Box sx={{ p: "0px 0px ", width: "100%", height: "auto", overflow: "hidden" }}>
                                            <img src={item.img} alt={item.img} style={{ objectFit: "cover", width: "100%", height: "100%", }} />
                                        </Box>
